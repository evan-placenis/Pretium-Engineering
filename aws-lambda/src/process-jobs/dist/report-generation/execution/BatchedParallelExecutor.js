...
class BatchedParallelExecutor {
        ...
        for (const [title, children] of groupMap.entries()) {
            const parentSection = {
                ...
                children: children.map(child => ({
                    id: child.id || (0, uuid_1.v4)(), // Reuse ID if available
                    number: '',
                    bodyMd: child.bodyMd,
                    images: child.images,
                })),
    ...
    async processBatch(batch, params) {
        ...
        const specificationsText = await (0, guards_1.getRelevantKnowledgeChunks)(supabase, projectId, queryForSpecs);
...
exports.BatchedParallelExecutor = BatchedParallelExecutor;
//# sourceMappingURL=BatchedParallelExecutor.js.map